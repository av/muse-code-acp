...
**Worker:** worker1 **Goal:** Implement explicit automatic approval/rejection and independently selected sandbox posture without weakening defaults. **Status:** done

## Tasks (in order)

| id   | title                                                                | est | depends_on             |
| ---- | -------------------------------------------------------------------- | --- | ---------------------- |
| t001 | Define verified native and adapter approval policies — **DONE**      | 60m | w1/m10/t008            |
| t002 | Wire selected policies and actionable mode negotiation — **DONE**    | 60m | w2/m4/t001             |
| t003 | Implement automatic host-offered approval decisions — **DONE**       | 60m | w2/m4/t001, w2/m4/t002 |
| t004 | Handle native denial and policy-transition races — **DONE**          | 60m | w2/m4/t002, w2/m4/t003 |
| t005 | Verify independent sandbox launch controls — **DONE**                | 60m | w2/m4/t001             |
| t006 | Implement sandbox configuration and safe host replacement — **DONE** | 60m | w2/m4/t005             |
| t007 | Verify restoration and cross-surface isolation — **DONE**            | 60m | w2/m4/t004, w2/m4/t006 |
| t008 | Update adoption guidance and capability limits — **DONE**            | 30m | w2/m4/t007             |
| t009 | Simplify milestone changes — **DONE**                                | 30m | w2/m4/t008             |
| t010 | CI and behavior coverage — **DONE**                                  | 45m | w2/m4/t008, w2/m4/t009 |
| t011 | Close out milestone — **DONE**                                       | 15m | w2/m4/t010             |
...
Implementation, adoption guidance and simplification are verified in
[the evidence record](evidence.md). Final CI passed: 431 unit tests, 40 required live tests on each pinned host,
check/build and packed-install smoke. All acceptance criteria are verified.
