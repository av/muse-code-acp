...
**Worker:** worker1 **Goal:** ACP clients can genuinely gate Muse tool execution, answer supported user-input requests, cancel at every turn phase, and recover from stream gaps without duplicated side effects. **Status:** todo

## Tasks (in order)

| id   | title                                                           | est | depends_on |
| ---- | --------------------------------------------------------------- | --- | ---------- |
| t001 | Bridge real MSP approvals through ACP permission requests       | 60m | w1/m4/t009 |
| t002 | Isolate permission lifetimes and concurrent request correlation | 45m | t001       |
| t003 | Translate supported user input through ACP elicitation          | 60m | t002       |
| t004 | Cover cancellation and turn settlement races                    | 45m | t003       |
| t005 | Recover SDK view gaps without replaying execution               | 60m | t004       |
| t006 | Handle backend failures and dispose stale session state         | 45m | t005       |
| t007 | Prove approval decisions control real Muse tool effects         | 60m | t006       |
| t008 | Simplify                                                        | 30m | t007       |
| t009 | CI + test coverage                                              | 45m | t007, t008 |
