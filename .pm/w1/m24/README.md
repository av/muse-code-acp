...
**Worker:** worker1 **Goal:** Choose a supportable packaging approach based on platform, licensing and runtime availability. Implement standalone adapter packaging for verified supported targets. Make supported installation paths reviewable and document remaining distribution-policy choices. **Status:** todo

## Tasks (in order)

| id   | title                                                       | est | depends_on               |
| ---- | ----------------------------------------------------------- | --- | ------------------------ |
| t001 | Assess standalone and Muse runtime distribution constraints | 45m | w1/m8/t007               |
| t002 | Build reproducible standalone adapter artifacts             | 45m | w1/m24/t001              |
| t003 | Validate clean installation and document release options    | 45m | w1/m24/t002              |
| t004 | Simplify milestone changes                                  | 30m | w1/m24/t003              |
| t005 | CI and behavior coverage                                    | 45m | w1/m24/t003, w1/m24/t004 |
| t006 | Close out the milestone                                     | 15m | w1/m24/t005              |
