...
export class MuseLineParser {
    ...
    onGarbage;
    buffer = "";
    constructor(onEnvelope, onGarbage = () => { }) {
    ...
    parseLine(line) {
        ...
        if (parsed.data.schema_version !== MUSE_ENVELOPE_SCHEMA_VERSION) {
            ...
            this.onGarbage(trimmed, `unexpected schema_version ${parsed.data.schema_version} (expected ${MUSE_ENVELOPE_SCHEMA_VERSION}); passing through`);
        }
